...
esimu `0.2.0b4` is ready for public Beta validation when its TestPyPI and
...
WebSocket loop, SQLite restart persistence, two-semester neutral demo, CI,
release smoke, and bilingual docs.

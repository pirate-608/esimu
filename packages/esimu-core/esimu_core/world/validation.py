...
from esimu_core.world.theme_paths import active_theme_id, project_root
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="esimu project root; defaults to ESIMU_PROJECT_ROOT or discovery",
    )
    parser.add_argument(
        "--theme",
        default=None,
        help="theme ID; defaults to ESIMU_THEME",
    )
    return parser
